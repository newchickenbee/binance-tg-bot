...
exports.fetchHyperliquidPrices = fetchHyperliquidPrices;
 ...
 */
async function fetchHyperliquidPrices(symbols, results) {
    if (symbols.length === 0)
        return;
    try {
        ...
        const requestedCoins = new Map(); // HL Coin -> Original Symbol
